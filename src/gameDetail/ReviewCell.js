  ...
  renderEditControl = () => {
    return (
      <div className="rc-top-buttons">
        <img src="/aki-pages/images/icon_review_edit.svg"/>
        <img src="/aki-pages/images/icon_review_delete.svg"/>
      </div>
    ); 
  }
  ...
  render() {
    return (
      <div className="reviewCell">
        <img src="/aki-pages/images/placeholder_user.svg"/>
          ...
          <div className="rc-content">
            <div className="rc-content-top">
              <div className="rc-content-rating horizontal-direction">
                <h1>3.5</h1>
                <Rating
							    emptySymbol={<img src="/aki-pages/images/rate_star_empty_sm.svg" className="icon" alt="" />}
				          fullSymbol={<img src="/aki-pages/images/rate_star_full_sm.svg" className="icon" alt="" />}
			            fractions={2}
				          initialRating={3}
